package org.nasdanika.models.bw5.ecore.tests;
...
import org.nasdanika.models.bw5.ecore.EcoreGenBw5ProcessorsFactory;
 ...
 *
 */
public class TestBwModelDocGen {
	
	@Test
	public void testGenerateBwModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenBw5ProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenBw5ProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "bw.xmi");
		...
		String siteMapDomain = "https://bw5.models.nasdanika.org";		
